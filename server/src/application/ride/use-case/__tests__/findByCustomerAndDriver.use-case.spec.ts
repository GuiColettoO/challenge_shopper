...
describe('CreateDriverUseCase Integration Tests', () => {
  ...
  let findByCustomerAndDriverUseCase: FindRidesByCustomerAndDriverUseCase;
  ...
  beforeEach(async () => {
    ...
    findByCustomerAndDriverUseCase = new FindRidesByCustomerAndDriverUseCase(
      rideRepository
    );
  });
  ...
  test('should create an confirm', async () => {
    ...
    const rides = await findByCustomerAndDriverUseCase.execute({
      customer_id: '1',
      driver_id: '1',
    });
